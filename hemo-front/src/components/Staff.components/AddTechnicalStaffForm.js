...
import { addTechnicalStaff } from '../../api/staff';
import SideMenu from '../SideMenu';
import Header from '../Header';
import './FormStyles.css';

const AddTechnicalStaffForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await addTechnicalStaff(apiBaseUrl, token, formData);
    if (result.success) {
      setSuccess('Technical staff added successfully!');
      ...
      if (result.error.errors) {
        ...
        setErrors({ general: result.error || 'Failed to add technical staff.' });
      }
    }
  };
        ...
        <div className="content-area">
          <div className="form-section">
            <div className="form-card">
              <h2 className="content-header">Add Technical Staff</h2>
