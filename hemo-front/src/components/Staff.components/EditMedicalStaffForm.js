...
import { updateMedicalStaff } from '../../api/staff';
import Header from '../Header';
import SideMenu from '../SideMenu';
import './FormStyles.css';

const EditMedicalStaffForm = () => {
    ...
    const fetchStaffData = async () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          setErrors({ general: data.error || 'Failed to load staff data.' });
        }
      } catch (error) {
  ...
  const validateForm = () => {
    ...
    if (!formData.cnom) newErrors.cnom = 'CNOM is required.';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        setSuccess('Medical staff updated successfully!');
        setTimeout(() => navigate('/home/staff/medical'), 2000);
      } else {
        setErrors({ general: result.error || 'Failed to update medical staff.' });
      }
    } catch (error) {
      console.error('Error in handleSubmit:', error);
      setErrors({ general: 'Failed to update medical staff due to an error.' });
    }
  };
        ...
        <div className="content-area">
          <div className="form-section">
            <div className="form-card">
              <h2 className="content-header">Edit Medical Staff</h2>
              ...
              <div className="form-container">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    required
                  />
                  {errors.cnom && <div className="error-message">{errors.cnom}</div>}
                </div>
                <div className="form-group">
                  <label>Role</label>
                ...
                <div className="form-actions">
                  ...
                  <button
                    ...
                    onClick={() => navigate('/home/staff/medical')}
                  >
                    Cancel
                  </button>
                </div>
...
export default EditMedicalStaffForm;