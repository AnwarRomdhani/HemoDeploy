...
import { addParamedicalStaff } from '../../api/staff';
import SideMenu from '../SideMenu';
import Header from '../Header';
import './FormStyles.css';

const AddParamedicalStaffForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await addParamedicalStaff(apiBaseUrl, token, formData);
    if (result.success) {
      setSuccess('Paramedical staff added successfully!');
      ...
      if (result.error.errors) {
        ...
        setErrors({ general: result.error || 'Failed to add paramedical staff.' });
      }
    }
  };
        ...
        <div className="content-area">
          <div className="form-section">
            <div className="form-card">
              <h2 className="content-header">Add Paramedical Staff</h2>
...
export default AddParamedicalStaffForm;