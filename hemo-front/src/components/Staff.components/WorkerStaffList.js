...
import { getWorkerStaff, deleteWorkerStaff, updateUserProfile } from '../../api/staff';
import SideMenu from '../SideMenu';
import Header from '../Header';
import './Staff.css';

const WorkerStaffList = () => {
    ...
    <div className="app-container">
      ...
      <div className="main-content">
        ...
        <div className="content-area">
          <h2 className="content-header">Worker Staff List</h2>
          <div className="staff-section">
            ...
            <div className="content-header">
              ...
              <div className="action-buttons">
                <button
                  ...
                  onClick={() => navigate('/home/staff/worker/add')}
                >
                  Add Worker Staff
                </button>
              </div>
            ...
            {staffList.length === 0 ? (
              <p className="no-data">No worker staff found.</p>
            ) : (
                      ...
                      <tr key={staff.id}>
                        ...
                        <td>
                          <button
                            ...
                            onClick={() => navigate(`/home/staff/worker/edit/${staff.id}`)}
                          >
                            Edit
                          </button>
                          <button
...
export default WorkerStaffList;