...
import { addWorkerStaff } from '../../api/staff';
import SideMenu from '../SideMenu';
import Header from '../Header';
import './FormStyles.css';

const AddWorkerStaffForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await addWorkerStaff(apiBaseUrl, token, formData);
    if (result.success) {
      setSuccess('Worker staff added successfully!');
      ...
      if (result.error.errors) {
        ...
        setErrors({ general: result.error || 'Failed to add worker staff.' });
      }
    }
  };
        ...
        <div className="content-area">
          <div className="form-section">
            <div className="form-card">
              <h2 className="content-header">Add Worker Staff</h2>
...
export default AddWorkerStaffForm;