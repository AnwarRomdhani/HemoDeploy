...
import { addMedicalStaff } from '../../api/staff';
import SideMenu from '../SideMenu';
import Header from '../Header';
import './FormStyles.css';

const AddMedicalStaffForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await addMedicalStaff(apiBaseUrl, token, formData);
    if (result.success) {
      setSuccess('Medical staff added successfully!');
      ...
      if (result.error.errors) {
        ...
        setErrors({ general: result.error || 'Failed to add medical staff.' });
      }
    }
  };
        ...
        <div className="content-area">
          <div className="form-section">
            <div className="form-card">
              <h2 className="content-header">Add Medical Staff</h2>
