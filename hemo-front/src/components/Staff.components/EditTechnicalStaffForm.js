...
import { updateTechnicalStaff } from '../../api/staff';
import Header from '../Header';
import SideMenu from '../SideMenu';
import './FormStyles.css';

const EditTechnicalStaffForm = () => {
  ...
  useEffect(() => {
    const fetchStaffData = async () => {
      ...
      const response = await fetch(`${apiBaseUrl}technical-staff/${id}/`, {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await updateTechnicalStaff(apiBaseUrl, token, id, formData);
    if (result.success) {
      setSuccess('Technical staff updated successfully!');
      setTimeout(() => navigate('/home/staff/technical'), 2000);
    } else {
      setErrors({ general: result.error || 'Failed to update technical staff.' });
    }
  };
        ...
        <div className="content-area">
          <div className="form-section">
            <div className="form-card">
              <h2 className="content-header">Edit Technical Staff</h2>
              ...
              <div className="form-container">
                ...
                <div className="form-actions">
                  ...
                  <button
                    ...
                    onClick={() => navigate('/home/staff/technical')}
                  >
                    Cancel
                  </button>
                </div>
...
export default EditTechnicalStaffForm;